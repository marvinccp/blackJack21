const miModulo = (() => {
 ...
 const winPlayer1 = (msg) => {
  ...
  const NadieGana = (msg) => {
    let container = document.querySelector("#span-nadie-gana");
  ...
  const determinarGanador = () => {
    ...
    setTimeout(() => {
      if (puntosComputadora === puntosMinimos) {
        NadieGana("Nadie gana :( 🐒 ");
        estiloDisableBoton()
      } else if (puntosMinimos > 21) {
        estiloDisableBoton();
        winComputer("Computadora gana :rob");
        // alert("Computadora gana");
      } else if (puntosComputadora > 21) {
        estiloDisableBoton();
        // alert("Jugador Gana");
        winPlayer1("Jugador Gana");
      } else {
        estiloDisableBoton();
        // alert("Computadora Gana");
         winComputer("Computadora gana");
      }
    }, 100);
  };
